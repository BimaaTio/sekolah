      ...
      <nav class="navbar navbar-expand-lg main-navbar navbar-dark bg-dark">
        ...
        <ul class="navbar-nav navbar-right">
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            <img alt="image" src="../assets/img/profil/profil.png" class="rounded-circle mr-1">
        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-users"></i> <span>Akun</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="?hal=super">Akun Super Admin</a></li>
                  <li><a class="nav-link" href="?hal=admin">Akun Admin</a></li>
                  <li><a class="nav-link" href="?hal=guru">Akun Guru</a></li>
                  <li><a class="nav-link" href="?hal=siswa">Akun Siswa</a></li>
                </ul>
              </li>
