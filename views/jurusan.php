...
<body">
    ...
    <div class="container">
        <div class="row">
            <br>
            <br>
            <h3 class="mt-3 text-center">Jurusan</h3>
            <br>
            <br>
            <!-- Jurusan -->
            ...
            ?>
                <div class="col">
                    <div class="card h-100">
                        <img src="../assets/img/logo/<?= $j['logo'] ?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <a href="detail-jurusan.php?nj=<?= $j['id_jurusan'] ?>" class="link"><p class="card-text h4 text-center"><?= $j['nama'] ?></p></a>
                        </div>
                    </div>
                </div>
            <?php endwhile; ?>   
